package com.dlm.android.service
...
class DownloadService : LifecycleService() {
    ...
    private fun buildNotification(s: QueueSnapshot): Notification {
        ...
        val waiting = s.downloads.count { it.state == com.dlm.android.scheduler.QState.QUEUED }
        val text = when {
            active > 0 -> speed
