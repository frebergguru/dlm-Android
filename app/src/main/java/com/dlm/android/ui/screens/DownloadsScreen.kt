...
fun DownloadsScreen(vm: QueueViewModel, modifier: Modifier = Modifier, onAddClick: () -> Unit, onOpenStatus: () -> Unit = {}) {
    ...
    val statusItems by com.dlm.android.repo.StatusCenter.items.collectAsState()
    val running = statusItems.any { it.state == com.dlm.android.repo.StatusState.RUNNING }
